...
while 1:
    ...
    adamCuda.proj_truth_tensor = proj_truth_tensor.clone()
    adamCuda.pof_truth_tensor = pof_truth_tensor
    adamCuda.calib_tensor = calib_tensor
    ...
    # No Translation
    A = torch.cat([adamCuda.drdP_tensor[112*2:112*2+53*3, :], adamCuda.drdc_tensor[112*2:112*2+53*3, :]], 1)
    B = torch.cat([adamCuda.dposepriorlossdP_tensor, dposepriorlossdc_tensor], 1)
    C = torch.cat([dshapecoefflossdP_tensor, adamCuda.dshapecoefflossdc_tensor], 1)
    J = torch.cat([A,B,C], 0)
